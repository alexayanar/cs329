...
df.add_user_transition(State.INTRO, State.UNSURE, r"[#ONT(unsure)]")
...
df.system_transition(State.UNSURE, State.INTRO, '"We can talk about a lot of things! We could talk about covid, or '
                                                'transitioning into this quarantine, the future, what you\'re doing,'
                                                ' \n '
                                                'what to do if you\'re bored, grounding exercises, stress, hygiene, if '
                                                'you suspect you\'re sick. There are a lot of them, take our pick."')
...
df.add_system_transition(State.a4, State.INTRO, '"I hope the fresh fruit didn\'t cause the disinterest! \n'
                                             'Or is it something else? Do you have something on your mind?"')
df.add_system_transition(State.a6, State.INTRO, '"I could keep going all day! But I won\'t- is there something '
                                             'weighing on you?"')
...
df.add_system_transition(State.a8, State.INTRO, '"Maxed out already, huh? That\'s okay. Is there something weighing'
                                             ' on you?"')
df.add_system_transition(State.a9, State.INTRO, '"I could keep going all day! But I\'ll spare you. Is there a chance'
...
df.add_user_transition(State.t29, State.INTRO, r"[#ONT(no)]")
df.set_error_successor(State.t29, State.INTRO)
...
df.add_system_transition(State.a11, State.INTRO, '"I could keep going all day! But I\'ll spare you. Is there '
...
df.add_system_transition(State.e10, State.INTRO, '"Good idea. We can\'t let this governor put profit over people. '
