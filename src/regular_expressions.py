...
def turn_3a(res: SimpleNamespace):
    # use version to find years old and confirm
    #you come into 3a with version already confirmed
    #match up the year with the version and make that input for print statement
    year = res.d_iphone_v[res.in_phone_version]
    old = year
